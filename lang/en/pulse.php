...
$string['Scheduleuser_vars'] = 'Scheduled User';
$string['Scheduleuser_vars_help'] = 'Scheduled user information placeholders';
...
$string['creditsfielddesc'] = 'Select any of the user custom profile field to maintain the user credits records <br> NOTE: Lock the selected field for students to prevent that students change their credit scores';
$string['cssclass'] = 'CSS class';
$string['custom'] = 'Custom';
$string['customcron'] = 'Custom (Crontab)';
$string['daily'] = 'Daily';
...
$string['interval_help'] = 'Define the interval for the recurring reminder. For example, if you select "Weekly" with an interval of 2, the reminder will be sent every two weeks.';
...
$string['modtitle_help'] = 'The title is used as activity name. It is used as subject to send the invitation.';
...
$string['setupcredit'] = 'In order to use this feature, you need to configure the user profile field first. Please ask your local administrator to set this up.';
$string['show'] = 'Show';
...
$string['subplugintype_pulseaction'] = 'Pulse automation action';
...
$string['visibility_help'] = 'Choose whether you want this template to be visible or hidden. <b>Note:</b> If hidden, users won\'t be able to create new instances based on this template, but existing instances will still be available.';
